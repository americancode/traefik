...
Purpose: Basic Gateway API routing via HTTPRoute.
...
TEST_DIR="/Users/nathaniel/source/traefik-src/traefik/script/kind-session-persistence/tests/basic-routing-gateway"
...
curl -s -H 'Host: whoami-gw-basic.localhost' http://localhost:8001/ | rg -n '^Hostname:'
