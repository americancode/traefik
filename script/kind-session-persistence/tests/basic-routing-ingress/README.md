...
Purpose: Basic Kubernetes Ingress routing (kubernetesIngress provider).

Hosts:
- whoami-ingress-basic.localhost
...
TEST_DIR="/Users/nathaniel/source/traefik-src/traefik/script/kind-session-persistence/tests/basic-routing-ingress"
...
curl -s -H 'Host: whoami-ingress-basic.localhost' http://localhost:8001/ | rg -n '^Hostname:'
