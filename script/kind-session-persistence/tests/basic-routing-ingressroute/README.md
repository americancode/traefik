...
Purpose: Basic Traefik IngressRoute routing.

Hosts:
- whoami-ir-basic.localhost
...
TEST_DIR="/Users/nathaniel/source/traefik-src/traefik/script/kind-session-persistence/tests/basic-routing-ingressroute"
...
curl -s -H 'Host: whoami-ir-basic.localhost' http://localhost:8001/ | rg -n '^Hostname:'
