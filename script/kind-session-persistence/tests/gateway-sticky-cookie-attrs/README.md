...
Purpose: Gateway API cookie attributes (Permanent + AbsoluteTimeout).

Hosts:
- whoami-cookie-attrs.localhost
...
TEST_DIR="/Users/nathaniel/source/traefik-src/traefik/script/kind-session-persistence/tests/gateway-sticky-cookie-attrs"
...
curl -s -D - -H 'Host: whoami-cookie-attrs.localhost' http://localhost:8001/ -o /dev/null | rg -i '^Set-Cookie:'
