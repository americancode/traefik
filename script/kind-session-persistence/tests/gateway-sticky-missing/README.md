...
Purpose: Missing cookie should not stick; expect >1 hostname.
...
TEST_DIR="/Users/nathaniel/source/traefik-src/traefik/script/kind-session-persistence/tests/gateway-sticky-missing"
...
for i in $(seq 1 10); do curl -s -H 'Host: whoami-missing.localhost' http://localhost:8001/ | rg -n '^Hostname:'; done | sort -u
