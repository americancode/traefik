...
Purpose: TraefikService cookie attributes applied to sticky responses.

Hosts:
- whoami-ts-attrs.localhost
...
TEST_DIR="/Users/nathaniel/source/traefik-src/traefik/script/kind-session-persistence/tests/gateway-traefikservice-cookie-attrs"
...
curl -s -D - -H 'Host: whoami-ts-attrs.localhost' http://localhost:8001/sticky -o /dev/null | rg -i '^Set-Cookie:'
