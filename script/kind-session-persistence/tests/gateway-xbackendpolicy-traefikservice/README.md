...
Purpose: TraefikService stickiness takes precedence over HTTPRoute and XBackendTrafficPolicy.
...
TEST_DIR="/Users/nathaniel/source/traefik-src/traefik/script/kind-session-persistence/tests/gateway-xbackendpolicy-traefikservice"
...
curl -s -D - -H 'Host: whoami-xbtp-ts.localhost' http://localhost:8001/ -o /dev/null | rg -i '^X-'
